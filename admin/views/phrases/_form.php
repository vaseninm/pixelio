...
<div class="form">
    ...
    <?php echo $form->radioButtonListControlGroup($model, 'type', Phrases::$types, array('span' => 5)); ?>

    <?php echo $form->textFieldControlGroup($model, 'value', array(
        'span' => 5, 'maxlength' => 255, 'data-type' => Phrases::TYPE_TEXT,
    )); ?>
    <?php echo $form->textAreaControlGroup($model, 'value', array(
        'rows' => 6, 'span' => 8, 'data-type' => Phrases::TYPE_HTML,
    )); ?>
    <?php echo $form->fileFieldControlGroup($model, 'file', array(
        'span' => 5, 'maxlength' => 255, 'data-type' => Phrases::TYPE_IMAGE,
    )); ?>
...
$(document).ready(function(){
    function enableActiveInput(){
        var type = $("input[id^=Phrases_type_]:checked").val();
        for(var i = 1; i <= 3; i++) {
            if (type == i) {
    ...
    enableActiveInput();
    $("input[id^=Phrases_type_]").click(function(e) {
        enableActiveInput();
    });
});
