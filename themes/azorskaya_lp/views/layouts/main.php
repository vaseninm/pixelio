	...
	<div class="container">
		...
		<!-- Slider No.3 -->
				<div class="da-slide">
					...
					<p>3 основных пакета Дизайн-проектов <br>Реальная и прозрачная ценовая политика стройки</p>
	...
	<!-- Features div -->
		...
		<h2 class="cnt-title left-title">Наши преимущества</h2>
			...
			<div class="row-fluid">
				<div class="span6">
					<div class="items">
						<h2 id="f-1">Опыт работы</h2>
						<p>Студия дизайна Инны Азорской открылась в 2007г. Более 6-ти лет опыта работы и мы постоянно совершенствуемся.</p>
					</div>
					<div class="items">
						<h2 id="f-2">Успешность</h2>
						<p>Более 50 реализованных проектов. Среди них как частные дома и квартиры, так и офисные помещения.</p>
					</div>
					<div class="items">
				...
				<div class="span6">
					<div class="items">
						...
						<p>Ведерживание сроков при проектировании и строительстве. Мы всегда оптимизируем процесс проектирования и работы.</p>
					</div>
					<div class="items">
						<h2 id="f-5">Актуальность</h2>
						<p>Просчет стоимости материалов в процессе проектирования. Маркетинг цен по Москве.</p>
					</div>
					<div class="items">
						<h2 id="f-6">Честность</h2>
						<p>Конечная цена без наценок и удорожания.</p>
					</div>
				</div>
			</div>
...
<section class="marginTop30" id="inna">
	<div class="container" id="holder1">
		<h2 class="cnt-title left-title">Журналы, о себе</h2>
		<div class="splitter"></div>
		<div class="row-fluid">
			<div class="span7">		
				<div class="row-fluid">
            ...
            <div class="span5">
				<div class="items">
					...
					<h3>Здравствуйте!<br> Меня зовут Инна Азорская Я и моя студия готовы предложить вам текст, текст, текст, текст, текст</h3>
				</div>
            </div>
        </div>
	...
	<div class="container" id="zahvat3">
		<div class="row-fluid">
            <div class="span12 centered">
				<h2 class="coffe">Для Вашего удобства мы можем обсудить Ваш проект в формате ВСТРЕЧИ, поэтому предлагаем Вам встретиться за чашечкой кофе или чая в Москве, 
