...
<!-- Header div -->
	<header>
		...
		<h3>Авторский контроль дизайнера. Точное соответствие ТЗ.</h3>
		<h3>Профессиональная строительная бригада, 10000 р.м<sup>2</sup>.</h3>
		</div>
		</div>
	</header>
<!-- /Header div -->
		...
		<div class="row-fluid marginBottom30">
			...
			<div class="span5">
				<p class="otziv">
					...
					березовых дров. 
					<span class="hideOtziv">
						Конечно, он не настоящий, так как наш современный дом не позволяет такую роскошь, но всем кажется,
					...
					<br>
					<a href="#" class="hideShowOtziv">Развернуть текст</a>
				</p>
			</div>
		</div>
		<div class="row-fluid marginBottom30">
		...
		<div class="row-fluid marginBottom30">
			...
			<div class="span5">
				<p class="otziv">
					...
					Через "седьмые руки" мы узнали об Инне Азорской.
					<span class="hideOtziv">					
						Посмотрев портфолио на сайте, поняли, что ее работы нам близки по стилю, решили встретиться.<br> 
...
$(document).ready(function(){
		$('.hideOtziv').hide();
        $('a.hideShowOtziv').click(function(){
            var txt = "Развернуть текст";
            if ($(this).html()==txt)
            {
                txt = "Свернуть текст";
            }
            ...
            $(this).siblings('.hideOtziv').stop(false, true).slideToggle('medium');
			return false;
        });
    });
</script>
